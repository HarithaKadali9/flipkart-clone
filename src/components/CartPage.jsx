    ...
    <div>
      ...
      <ul className="flex flex-wrap justify-between p-4 m-4 rounded">
        {items.map((item, index) => (
          <li key={index} className="p-4 m-4 border shadow-md">
      ...
      <button className='border bg-green-400 text-white rounded p-2'>Proceed to payment</button>
      <button className='border bg-red-500 text-white rounded p-2'>Cancel</button>
    </div>
  );
};
